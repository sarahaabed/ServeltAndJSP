                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div> 
                                <form style="padding: 12px 0 0 100px;" method="get" action="home"  > 
                                    <fieldset style="margin: 0; padding: 0; border: none;"> 
                                        <input name="searchPrice" placeholder="Search By price" type="text" 
                                               style="vertical-align: bottom; margin: 0; padding: 0; font-size: 12px; width: 60%;" /> 
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="left-sidebar">
                            ...
                            <div class="shipping text-center"><!--shipping--> <!---Advertise-->
